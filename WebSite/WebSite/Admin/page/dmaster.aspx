<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSite.Master" AutoEventWireup="true" CodeBehind="dmaster.aspx.cs" Inherits="WebSite.Admin.page.Cooperation.dmaster" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            $.ajax({
                ...
                data: { key: 'dmaster', content: CKEDITOR.instances.ckeditor.getData() },
                dataType: 'json',
                success: function (msg) {
                    if (msg && msg.Flag) {
                        if (msg.Flag)
