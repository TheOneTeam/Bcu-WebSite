<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSite.Master" AutoEventWireup="true" CodeBehind="sumschool.aspx.cs" Inherits="WebSite.Admin.page.Cooperation.sumschool" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            $.ajax({
                ...
                data: { key: 'sumschool', content: CKEDITOR.instances.ckeditor.getData() },
                dataType: 'json',
                success: function (msg) {
                    if (msg && msg.Flag) {
                        if (msg.Flag)
