<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSite.Master" AutoEventWireup="true" CodeBehind="service.aspx.cs" Inherits="WebSite.Admin.page.service" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            $.ajax({
                ...
                data: { key: 'studentservice', content: CKEDITOR.instances.ckeditor.getData() },
                dataType: 'json',
                success: function (msg) {
                    if (msg && msg.Flag) {
                        if (msg.Flag)
