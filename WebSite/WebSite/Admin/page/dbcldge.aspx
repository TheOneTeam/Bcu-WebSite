<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSite.Master" AutoEventWireup="true" CodeBehind="dbcldge.aspx.cs" Inherits="WebSite.Admin.page.dbcldge" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            $.ajax({
                ...
                data: { key: 'dbcldge', content: CKEDITOR.instances.ckeditor.getData() },
                dataType: 'json',
                success: function (msg) {
                    if (msg && msg.Flag) {
                        if (msg.Flag)
