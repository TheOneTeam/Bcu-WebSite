<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSite.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="university.aspx.cs" Inherits="WebSite.Admin.page.University" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            $.ajax({
                ...
                data: { key: 'university', content: CKEDITOR.instances.ckeditor.getData() },
                dataType: 'json',
                success: function (msg) {
                    if (msg && msg.Flag) {
                        if(msg.Flag)
